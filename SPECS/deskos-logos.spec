...
Source0: https://dl.deskosproject.org/sources/deskos-logos/deskos-logos-%{version}.tar.xz
License: Copyright © 2016 DeskOS Project. All rights reserved.
...
%description
The deskos-logos package (the "Package") contains files created by the
DeskOS Project to replace the Red Hat "Shadow Man" logo and  RPM logo.
The Red Hat "Shadow Man" logo, RPM, and the RPM logo are trademarks or
registered trademarks of Red Hat, Inc.

The Package and DeskOS logos (the "Marks") can only used as outlined
in the included COPYING file. Please see that file for information on
copying and redistribution of the DeskOS Marks.
